  ...
  <body>
    <div class="container-fluid main pb-5">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-brand text-warning" href="#"><i class="fas fa-lightbulb"></i> Sugestões</a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <a class="nav-link" href="https://forms.gle/1XEmE7oZiEKFthd68">Cadastro (opcional)</a>
                    </li>
                </ul>
                <form class="d-flex">
        ...
        <div class="container text-center">
            ...
            <a class="btn btn-warning btn-sm p-4 px-1 shadow" type="submit" href="#sugestao"><i class="far fa-lightbulb"></i> Clique aqui para deixar sua sugestão</a>
        </div>
    </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header bg-warning border-0">
            ...
            <div class="modal-body px-5 py-5"> Obrigado pelo seu comentário, estaremos analizando.
          </div>
        </form>
        </div>
      </div>
