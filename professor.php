            ...
            <table class="table table-striped">
              ...
              <tbody>
				...
				?>
					...
					<td id="telefone<?=$row->id?>"><?=$row->telefone; $tel = $row->telefone?></td>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header bg-warning border-0">
            <h5 class="modal-title" id="exampleModalLabel"><i class="far fa-lightbulb"></i> Sugestão</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-header px-5 pt-2" id="analise-cabecalho">
          </div>
          <div class="modal-body px-5 pt-2" id="analise-cima">
          </div>
          <div class="modal-body px-5 pt-2" id="analise-body">
          </div>
          <div class="modal-footer border-0 px-5 pb-5">
		  	<form action="whatsapp.php" method="POST" target="_blank" title="WhatsApp" alt="WhatsApp">
					<button type="submit" class="btn btn-dark" id="btn-whatsapp" name="whats" value="">Responder &nbsp;<img src="img/whatsapp.png" style="width:20px;"/></button>
			  </form>
          <button type="submit" class="btn btn-dark" id="btn-email" name='email'>Copiar E-mail
            <img title='Copiar e-mail para área de transferência' src='img/email.png' style='width:25px;'>
                        <script>
                          let btn = document.querySelector('#btn-email');
                          btn.addEventListener('click', function(e) {
                            let textArea = document.querySelector('.copia-email');
                            textArea.select();
